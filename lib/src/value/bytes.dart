...
abstract class CborBytes extends CborValue {
  const factory CborBytes(List<int> bytes, {List<int> tags}) = _CborBytesImpl;
...
abstract class CborEncodeIndefiniteLengthBytes extends CborValue {
  const factory CborEncodeIndefiniteLengthBytes(List<List<int>> items,
...
abstract class CborEncodeDefiniteLengthBytes extends CborValue {
  const factory CborEncodeDefiniteLengthBytes(CborBytes input) =
...
abstract class CborBigInt extends CborBytes implements CborInt {
  ...
  const factory CborBigInt.fromBytes(List<int> bytes, {List<int> tags}) =
      _CborBigIntImpl.fromBytes;

  const factory CborBigInt.fromNegativeBytes(List<int> bytes,
      {List<int> tags}) = _CborBigIntImpl.fromNegativeBytes;
